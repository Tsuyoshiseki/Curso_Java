...
//Entrada
        System.out.println("Insria o primeiro lado do triângulo");
        lado1 = scan.nextDouble();
        
        System.out.println("Insria o segundo lado do triângulo");
        lado2 = scan.nextDouble();
        
        System.out.println("Insria o terceiro lado do triângulo");
...
//Processamento
        if(lado1 + lado2 > lado3 && lado1 + lado3 > lado2 && lado3 + lado2 > lado1){
            ...
            System.out.println("Os dados apresentados não correspondem a um triângulo");
        }
